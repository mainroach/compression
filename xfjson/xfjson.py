...
class BinaryJSON(object):
    ...
    def encode(self,jsonObj):
        self._binaryStream = byteStream.ByteStreamWriter()                    
    ...
    def decode(self,bytes):
        self._binaryStream = byteStream.ByteStreamReader()
...
def encodeJSON(inFile,outFile, dataTransposeMode,doBinPack):
    ...
    #clean up the JSON data a little bit; for example, JSONP information...
    #technically, we shouldn't strip JSONP, we should just view it as a string.
    jsdata = stripJSONP(jsdata)
